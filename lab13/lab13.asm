...
LOAD	
	LD R3, R6 ; loaded m[m[LETTERTWO]] into R3
...
NEXT_NEXT_COLUMN
	...
	ADD R1, R1, #0    
	BRz NEXT_ROW		  ; branch to done when all rows are printed
	

	
NEXT_COLUMN
	ADD R4, R4, #0 
	BRz DONE_COLUMN     ; branches to next row if column counter reaches 0
